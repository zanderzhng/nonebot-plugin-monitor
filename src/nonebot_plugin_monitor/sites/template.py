...
2. Modify the class name and implement all required methods
3. Restart the bot to load the new site
"""
...
class TemplateSite(BaseSite):
    """Template for site subscription implementation - REPLACE TemplateSite with your site name"""
